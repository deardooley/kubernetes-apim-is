...
Common labels
*/}}
{{- define "am-mysql.labels" -}}
app.kubernetes.io/name: {{ include "am-mysql.name" . }}
helm.sh/chart: {{ include "am-mysql.chart" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
...
Common prefix prepended to Kubernetes resources of this chart
*/}}
{{- define "am-mysql.resource.prefix" -}}
{{- "wso2mysql-pattern-1" }}
{{- end -}}
