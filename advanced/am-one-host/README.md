...
| `wso2.deployment.am.admin.username`                                         | The username of the apim admin user created by default on initial installation            | admin                       |
| `wso2.deployment.am.admin.password`                                         | The password of the apim admin user created by default on initial installation            | admin                       |
